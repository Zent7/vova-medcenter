...
TEMPLATE_DISPLAY_NAMES = {
    # Номера в комментариях — строки списка услуг из файла "МММ программы с названиями усл".
    "АМБ_карты_профосмотр_шаблон.xls": "Проф",  # 1
    "Выписка из Амб карты (профа).xls": "Проф с выпиской",  # 2
    "ЛМК_справка_шаблон.docx": "ЛМК справка",  # 3
    "ЛМК.xls": "ЛМК-Н, ЛМК-ПР",  # 4
    "CправкаБассейн_шаблон.docx": "бассейн",  # 6
    "СПОРТ.xls": "спорт",  # 7
    "Охрана_шаблон.docx": "002 (чод)",  # 8
    "Чод_новый.xml": "чод — выгрузка XML",  # 8
    "ГИМС (судна).xls": "гимс",  # 9
    "ГИМС_шаблон_для_загрузки_из_файла.xml": "гимс — выгрузка XML",  # 9
    "трактор лиц ст.xls": "071у — лицевая",  # 10
    "трактор об ст.xls": "071у — оборот",  # 10
    "Трактроная_новый-шаблон.docx": "071у — Word",  # 10
    "ВУ.xls": "ВУ (водительская)",  # 11
    "Водительская(новая).xml": "ВУ (водительская) — выгрузка XML",  # 11
    "086у.жен_шаблон.docx": "086у (Ж)",  # 12
    "086у.муж_шаблон_2.docx": "086у (М)",  # 13
    "ГС НОВЫЙ ФОРМАТ.xls": "ГС",  # 14
    "ГТ.xls": "ГТ",  # 15
    "СКК 72 новый формат.xls": "072 у СКК",  # 16
    "СКК 070 новый формат.xls": "070у",  # 17
    "082у_шаблон.docx": "082у",  # 18
    "Справка_342н_псих_освид.xls": "342н псих осв",  # 19
    "Псих. осв.docx": "342н псих осв — Word",  # 19
    "095У_справка_шаблон.docx": "095у",  # 20
    # Шаблонов для строк 5 (амб карта) и 21 (СЭМТ-196) в папке пока нет.
    # Ниже — документы, которых нет в списке МММ, но приложение их печатает.
    "Заключение29Н_шаблон.docx": "Заключение 29н",
    "ПрофосмотрВыписка_шаблон.docx": "Выписка профосмотра",
