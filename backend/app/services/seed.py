...
SERVICE_CATALOG = [
    ...
    (43, 7, "Справка по форме СЭМД-196 без ФЛГ", "2500.00"),
    (44, 7, "Справка по форме СЭМД-196 с ФЛГ", "3500.00"),
    (45, 7, "ФЛЮОРОГРАФИЯ", "0.00"),
    (13, 8, "УЗИ брюшной полости", "2000.00"),
    (14, 8, "УЗИ молочных желез", "1500.00"),
    (15, 8, "УЗИ предстательной железы", "1500.00"),
    (20, 9, "ЭКГ без расшифровки", "700.00"),
...
SERVICE_DOCTOR_ROLE_IDS = {
    8: [1, 4, 5, 7],
    29: [1, 7],
    # 071у: терапевт, психиатр, нарколог и офтальмолог на любые категории,
    # невролог и отоларинголог — на C, D и E (driver_rules.tractor_certificate_doctor_roles).
    7: [1, 2, 3, 4, 5, 7],
    37: [1, 13],
    ...
    39: [1, 13],
    40: [2, 4, 1, 13],
    # СЭМД-196 заменила 086у и печатается её бланком: те же врачи, что у 086у.
    43: [6, 1, 10, 4, 7, 5, 13],
    44: [6, 1, 10, 4, 7, 5, 13],
}
...
VISIT_TYPES = [
    ...
    ("086", "Справка СЭМД-196", "Справка для поступления и обучения"),
...
VISIT_TYPE_SERVICE_LEGACY_IDS = {
    ...
    "sport": [4, 5],
    "guard": [11],
    "other": [2, 3, 10, 24, 27, 30, 31, 32, 38, 40, 45],
}
