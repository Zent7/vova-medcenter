...
class ProfExtractDoctorRowsTests(unittest.TestCase):
    ...
    def test_generated_amb_sheet_hides_unused_blocks_and_compacts_pz2_rows(self):
        ...
        template_book = xlrd.open_workbook(file_contents=self._ambulatory_template_path().read_bytes(), formatting_info=True)
        template_amb_sheet = template_book.sheet_by_index(0)
